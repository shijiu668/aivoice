  ...
  return (
    <footer className="bg-apple-dark text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-12">
          <h3 className="text-2xl font-bold mb-4 text-gradient">AI Voice Generator</h3>
          <p className="text-gray-300 mb-6 leading-relaxed max-w-4xl">
            Transform your text into realistic celebrity voices with our advanced AI voice generator.
            Create professional-quality voice content with our AI celebrity voice generator and AI voice changer technology.
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-8">
          <div>
            <h4 className="text-lg font-semibold mb-4">Political Voices</h4>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">Celebrity Voice</h4>
            <ul className="space-y-2">
              <li><a href="/taylor-swift" className="text-gray-300 hover:text-white transition-colors">Taylor Swift AI Voice</a></li>
              <li><a href="/ice-spice" className="text-gray-300 hover:text-white transition-colors">Ice Spice AI</a></li>
          ...
          <div>
            <h4 className="text-lg font-semibold mb-4">Character Voices</h4>
            <ul className="space-y-2">
