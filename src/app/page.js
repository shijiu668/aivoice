        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-20">
            ...
            <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-4xl mx-auto leading-relaxed animate-fade-in-up">
              Transform any text into realistic celebrity voices with our cutting-edge AI technology. 
              Create professional voice content instantly with our advanced AI voice generator and celebrity voice changer.
            </p>
